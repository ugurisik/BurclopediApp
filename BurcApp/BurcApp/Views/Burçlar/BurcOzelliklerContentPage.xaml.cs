...
namespace BurcApp.Views.Burçlar
{
    ...
    public partial class BurcOzelliklerContentPage : ContentPage
    {
        ...
        public BurcOzelliklerContentPage(Burclar bb)
        {
            InitializeComponent();
        ...
        {       
            ...
            ElementLabel.Text = b.Element.ToUpper();
            SayiLabel.Text = b.Sayi.ToUpper();
            GunLabel.Text = b.Gun.ToUpper();
            RenkLabel.Text = b.Renk.ToUpper();
            TasLabel.Text = b.Tas.ToUpper();
            KadinBaslikLabel.Text = b.Ad + " KADINI";
            KadinOzellikLabel.Text = b.Kadin;
            ErkekBaslikLabel.Text = b.Ad + " ERKEĞİ";
            ErkekOzellikLabel.Text = b.Erkek;
